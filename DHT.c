...
int idp; // id CHORD
int fingerp[M]; // finger table du processus
int peers[NB_SITE]; // listes des identifiants CHORD
int succp; // successeur du processus
int rang; // rang MPI
node* list = NULL; // liste des clés dont le processus est responsable
...
// à utiliser avec la finger table;
...
// Cherche le plus grand finger tq %d appartient à ]j, %d]\n", idp, k, idp
int findnext(int k){
...
// Recherche le responsable de la clé k
...
void simulateur(void) {
   ...
   // Génération aléatoire des identifiants CHORD des pairs
